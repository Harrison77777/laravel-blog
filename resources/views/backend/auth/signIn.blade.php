        ...
        <div class="card">
            <div class="body">
                @if (Session::has('successMsg'))
                   <div class="alert alert-danger w-100">{{session('successMsg')}}</div> 
                @endif
                <form id="sign_in" action="{{route('admin.login.attempt')}}" method="POST">
                    @csrf
                    <div class="msg">Login to access the admin panel</div>
