                ...
                <div class="header custom">
                    <div class="row">
                        ...
                        <div class="col-lg-6 custom2">
                            <a class=" btn btn-danger btn-sm waves-effect" href="{{route('admin-profile.setting')}}">BACK</a>
                        </div>
                    </div>
                </div>
                <div class="body">
                    <div role="tabpanel" class="tab-pane fade in" id="profile_settings">
                        <form class="form-horizontal" action="{{route('admin-profile.reset.password')}}" method="POST">
                            @csrf
                            @method("PATCH")
