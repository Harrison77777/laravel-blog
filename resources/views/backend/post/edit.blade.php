    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body h-100">
                <form class="col-lg-12 w-100" method='post' action="{{route('post.update', $post->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method("PATCH")
                    <div class="row clearfix">
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <br>
                                    <img height="100" width="150" width="" src="{{asset('storage/post/'.$post->image)}}" alt="">
                                    <br>
