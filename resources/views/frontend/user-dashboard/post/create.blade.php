...
@section('title', 'Create new user post')
@push('css')
<!-- Bootstrap Select Css -->
<link href="{{asset('frontend/userDashboard/plugins/bootstrap-select/css/bootstrap-select.css')}}" rel="stylesheet" />
@endpush
@section('content')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body h-100">
                <form class="col-lg-12 w-100" method='post' action="{{route('userPost.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row clearfix">
                        <div class="col-lg-8">
                            <div class="card">
...
@push('js')
 ...
 {{-- Multi Select Plugin Js  --}}
    <script src="{{asset('frontend/userDashboard/plugins/multi-select/js/jquery.multi-select.js')}}"></script>

<script src="{{asset('frontend/userDashboard/plugins/tinymce/tinymce.js')}}"></script>
<script>
    @if ($errors->any())
    ...
    $(function () {
        ...
        tinymce.suffix = ".min";
        tinyMCE.baseURL = "{{asset('frontend/userDashboard/plugins/tinymce')}}";
    });
</script>
@endpush